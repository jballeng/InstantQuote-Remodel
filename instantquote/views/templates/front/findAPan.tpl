        ...
        <form action="" id="material_type_form"  onchange="" class="std" name="material_type_form" method="post">
            ...
            {* <div id="swiper" class="swiper">
                <div class="lastStep">
                    ...
                    {foreach $addOnProductsDatas as $addOnProduct}
                    <div class="form-group">                       
                            <label for="{$addOnProduct.name}" class="form-check-label"> 
                                <input type="checkbox" id="js-add-on-product" value="{$addOnProduct.id_product}" name="addOnProduct"> 
                                {$addOnProduct.name}
                            </label>
                    </div>
                    {/foreach}
                        ...
                        <form id="srpcustomerRequestQuote">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="business-personal" name="business_personal" class="rquiredFiled form-control"
                                        required>
