...
class MaterialSize extends ObjectModel {
    ...
    public static $definition = array(
        ...
        'fields' => array(
            ...
            'max_width' => array('type' => self::TYPE_STRING, 'validate' => 'isUnsignedInt', 'required' => true, 'size' => 32),
            'max_length' => array('type' => self::TYPE_STRING, 'validate' => 'isUnsignedInt', 'required' => true, 'size' => 32),
    ...
    public function add($autodate = true, $null_values = false) {
        //TODO: to check unique measurement
//        $material_type_name = $_POST['material_type_name'];        
//        if (!Validate::isUniqueCustom(self::$definition['table'], 'material_type_name', $material_type_name)) {
...
//        }
    ...
    /**
     * Function to get Material Price according to type
     * @return type
     */
    public static function getMaterialPrice($material_type_id=0){
        return Db::getInstance(_PS_USE_SQL_SLAVE_)->getRow('
			SELECT price_per_volume  
			FROM `' . _DB_PREFIX_ . 'iq_material_type` 
			WHERE is_active = 1 AND id_iq_material_type ='. $material_type_id);
    }
