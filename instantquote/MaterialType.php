...
class MaterialType extends ObjectModel {
    ...
    public static $definition = array(
        ...
        'fields' => array(
            ...
            'density' => array('type' => self::TYPE_FLOAT, 'required' => true),
    ...
    public function checkMaterialSizeMap($material_type_id){        
        return Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS('
			SELECT *
			FROM `' . _DB_PREFIX_ . 'iq_material_size` 
